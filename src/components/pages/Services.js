...
export default function Services() {
  return (
    <>
      ...
      <div className='services-container'>
          <div className='services-img-container'>
          <img src='images/wall.jpg' alt='horario' className='services-img' />
          </div>
          <text> 
            El Centro Cultural Shaolin Valencia organiza periódicamente viajes a China con la finalidad de que todas las personas interesadas en visitar China y profundizar en el estudio de las artes marciales tengan la oportunidad de hacerlo de la mano del Maestro Shi Xinghui.
      ...
      <div className='services-container'>
          <div className='services-img-container'>
          <img src='images/jump.jpg' alt='horario' className='services-img' />
          </div>
          <text> 
            El Maestro Shi Xinghui ofrece trabajos como actor y coreógrafo de artes marciales para el sector del cine y del teatro. En ambos sectores cuenta con una amplia experiencia, ya que ha llevado a cabo multitud de trabajos en diferentes países. Todo esto avala sus conocimientos y profesionalidad en el sector.
